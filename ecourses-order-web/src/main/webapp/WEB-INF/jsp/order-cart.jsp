...
<form id="orderForm" class="hide" action="/order/create.html" method="post">
  ...
  <div id="userAddrId" class="orderTbody ">
    <h3 class="orderTitle">购课人信息：<span class="addrAlter" style="display:inline;">[修改]</span></h3>
    <div class="orderItem">
        <div class="orderCurr" id="userAddress" style="display:block;">
          <ul>
            <li>test002&nbsp;&nbsp;&nbsp;&nbsp;15911100033&nbsp;&nbsp;&nbsp;&nbsp;test002@ecourses.cn</li>
          </ul>
        </div>
    </div>
  </div>
  ...
  <div id="producthtml">
	...
	<div id="chaidanorder2" class="">
		<div class="orderItem">
			<div class="dateShow">
				<strong>课程下单后尽快为您开通</strong>
			</div>
			<div class="orderTbl">
				<div class="orderThead">
					<div class="tCol">课程图片</div>
					<div class="tCol pGoods">课程名称</div>
					<div class="tCol pPrice">单价</div>
					<div class="tCol pPromotion"></div>
					<div class="tCol pInventory">报名状态</div>
				...
				<div class="orderPInfo">
					...
					<div class="pItem pInventory" pid="57111">未满</div>
  ...
  <div class="orderItem" style="position:relative;padding-top:10px;">
    ...
    <div class="order-info" style="z-index: -1;">
      ...
      <div id="priceitems" class="priceitem">
        <dl class="fl">
          <dd>
            <div>1 件课程，总课程金额：</div><span class="priceArea">¥<span id="yingProce">
  ...
  <div class="orderTFoot">
    ...
    <div class="submitOrder">
      ...
      <div class="orderAccount">
        ...
        <span class="p">¥</span>
        	<span id="countPrice" class="p"><fmt:formatNumber value="${totalPrice / 100}" maxFractionDigits="2" minFractionDigits="2" groupingUsed="true"/>
        </span>
      </div>
      <span class="clear"></span>
    </div>
