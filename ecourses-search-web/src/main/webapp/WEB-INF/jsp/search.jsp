...
<title>${query} - 课程搜索 - 易课寄在线购课系统</title>
   ...
   <a id="prolist-id"></a>
    <div class="r-filter">
      <div class="f-sort">
        ...
        <div class="total">共<span>${recourdCount }</span>个课程</div>
      </div>
    </div>
    ...
    <div class="p-list">
      <ul class="list-all">
         ...
         <li>
            <div class="l-wrap">
				<div class="pic">
					<a class="trackref" href="http://item.ecourses.cn/item/${item.id}.html" title="" target="_blank">
	            ...
	            <div class="title-a">
	                <a class="trackref presaleSign_225865" href="http://item.ecourses.cn/item/${item.id}.html" target="_blank">${item.title }</a>
	            </div>
	        	<div class="title-b" style=""><a class="trackref" href="http://item.ecourses.cn/item/${item.id}.html" target="_blank">${sell_point }</a></div>
	            <div class="comment">
	                <div class="owner_shop_list">优质课程</div>                    
	            </div>
		    </div>
		 </li>
         </c:forEach>
