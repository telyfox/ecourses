...
<head>
    ...
    <title>易课寄后台管理</title>
       <link rel="stylesheet" type="text/css" href="/js/sso/css/jquery.alerts.css" />
<link rel="stylesheet" type="text/css" href="/js/sso/css/headerfooterindex.css" />
<link rel="stylesheet" type="text/css" href="/js/sso/css/login.css" />
<script type="text/javascript" src="/js/sso/js/jquery-1.5.1.min.js"></script>
<script type="text/javascript" src="/js/sso/js/jquery.cookie.js"></script>
<script type="text/javascript" src="/js/sso/js/jquery.alerts.js"></script>
<script type="text/javascript" src="/js/sso/js/png.js"></script>
<script type="text/javascript" src="/js/sso/js/cas.login.js"></script>
<script type="text/javascript" src="/js/sso/js/capsLock.js"></script>
<script type="text/javascript" src="/js/ecourses.js"></script>
</head>
<body>
	<!-- header -->
	<div class="header">
		<img src="/js/sso/images/logo.png" border="0"><span>欢迎登录</span>
	</div>
	<!-- login_main -->
	<div class="login_main clear">
		<div class="pic">
			<img src="/js/sso/images/06f42c372620f92b40da77a8b23cdf7f.png">
		</div>
		<!-- login -->
		<div class="login">
    	...
    	<span>您还未登录</span>
			...
			<div class="login_box clear">
				<ul class="loginnav">
					<li class="curr" mark="sfbest"><em></em>管理员账号</li>
				</ul>
				...
				<div class="logincon">
					...
					<form id="formlogin" method="post" >
						...
						<li><span class="title">管理员账号<font style="padding-left:20px" class="error_line" color="#ff0000"></font></span>
						...
						<span style="position: absolute; font-size: 14px; left: 5px; top: 9px;display:none;" class="sfbest_username_place">请输入管理员账号</span>
							</span>
				...
				$.post("/user/login", $("#formlogin").serialize(),function(data){
					if (data.status == 200) {
						jAlert('登录成功！',"提示", function(){
							if (redirectUrl == "") {
								location.href = "http://admin.ecourses.cn";
							} else {
