...
<body>
	<!-- header -->
	<div class="header">
		<a href="http://www.ecourses.cn"><img src="/images/logo.png" border="0"><span>欢迎登录</span></a>
	</div>
	<!-- login_main -->
	<div class="login_main clear">
		<div class="pic">
			<a href="http://www.ecourses.cn/html/activity/1472720729.html" target="_blank"><img src="/images/06f42c372620f92b40da77a8b23cdf7f.png"></a>
		</div>
		<!-- login -->
		<div class="login">
    	...
    	<a href="/page/register">免费注册</a>
			...
			<div class="login_box clear">
				<ul class="loginnav">
					<li class="curr" mark="sfbest"><em></em>易课寄账号</li>
				</ul>
				...
				<div class="logincon">
					...
					<form id="formlogin" method="post" >
						...
						<li><span class="title">登录账号<font style="padding-left:20px" class="error_line" color="#ff0000"></font></span>
						...
						<li>
							<div style="width: 65px; margin-left: 260px;">
								<a href="https://passport.e3mall.cn/reg/findpass/?returnUrl=http://www.ecourses.cn" class="forget-passWord">忘记密码?</a>
							</div>
						</li>
				...
				<li class="p-f10">
						...
						<div>
							<a href="http://api2.e3mall.cn/unionlogin/qq/oauth/qq_login.php?returnUrl=http://www.ecourses.cn/" class="link">QQ</a>&nbsp;|&nbsp; <a href="https://api.weibo.com/oauth2/authorize?client_id=1800908332&amp;redirect_uri=https%3A%2F%2Fpassport.e3mall.cn%2Fcallback%2Fsina&amp;response_type=code&amp;state=&amp;display=?returnUrl=http://www.ecourses.cn/" class="link">新浪微博</a> &nbsp;|&nbsp; <a href="https://open.t.qq.com/cgi-bin/oauth2/authorize?client_id=801198099&amp;redirect_uri=https%3A%2F%2Fpassport.e3mall.cn%2Fcallback%2Fqq&amp;response_type=code&amp;type=?returnUrl=http://www.ecourses.cn/" class="link">腾讯微博</a> &nbsp;|&nbsp; <a href="http://api2.e3mall.cn/unionlogin/alipay.php?returnUrl=http://www.ecourses.cn/" class="link">支付宝</a>
						</div>
					</li>
	...
	<div class="footer">
		...
		<span> <a href="http://www.ecourses.cn/www/379/5109.html" rel="nofollow" class="footerlink1">关于我们</a> | <a href="http://www.ecourses.cn/www/380/5116.html" rel="nofollow" class="footerlink1">联系我们</a> | <a href="http://www.ecourses.cn/www/381/5117.html" rel="nofollow" class="footerlink1">招聘人才</a> | <a href="http://www.ecourses.cn/www/330/2705.html" rel="nofollow" class="footerlink1">友情链接</a> | <a href="http://supplier.e3mall.cn/supplierApply" rel="nofollow" class="footerlink1">供应商申请</a>
		</span>
				...
				$.post("/user/login", $("#formlogin").serialize(),function(data){
					if (data.status == 200) {
						jAlert('登录成功！',"提示", function(){
							if (redirectUrl == "") {
								location.href = "http://www.ecourses.cn:8082";
							} else {
