...
<body>
	...
	<div class="cartMain">
		<div class="cartThead" style="margin: 50px 0px 50px 50px;">
			<h3 class="cartMy">您的课程已经成功加入购物车！</h3>
			<div class="cartJsuan">
				<input type="button" class="goshop" onclick="window.history.back();return false;" value="返回"/>
				<input type="button" class="jiesuan youxuan" onclick="location.href='http://www.ecourses.cn:8090/cart/cart.html'" value="去购物车结算"/>
			</div>
		</div>
